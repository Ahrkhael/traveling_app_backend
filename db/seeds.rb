...
cities_with_monuments = [
  {
    name: 'Madrid',
    image_url: '/images/madrid/madrid.jpg',
    ...
    monuments: [
      { 
        ...
        latitude: 40.417957, 
        longitude: -3.714302, 
        image_url: '/images/madrid/palacio-real.jpg', 
      ...
      { 
        ...
        latitude: 40.415260, 
        longitude: -3.684416, 
        image_url: '/images/madrid/parque-retiro.jpg', 
      ...
      { 
        ...
        latitude: 40.416832, 
        longitude: -3.702163, 
        image_url: '/images/madrid/puerta-del-sol.jpg', 
      ...
      { 
        ...
        latitude: 40.409332, 
        longitude: -3.704330, 
        image_url: '/images/madrid/plaza-mayor.jpg', 
      ...
      { 
        ...
        latitude: 40.413780, 
        longitude: -3.692127, 
        image_url: '/images/madrid/museo-prado.jpg', 
      ...
      { 
        ...
        latitude: 40.420345, 
        longitude: -3.705774, 
        image_url: '/images/madrid/gran-via.jpg', 
  ...
  {
    name: 'Barcelona',
    image_url: '/images/barcelona/sagrada-familia.jpg',
    ...
    monuments: [
      ...
      { 
        ...
        latitude: 41.384087, 
        longitude: 2.176465, 
        image_url: '/images/barcelona/catedral-barcelona.jpg', 
      ...
      { 
        ...
        latitude: 41.380897, 
        longitude: 2.173503, 
        image_url: '/images/barcelona/liceu.jpg', 
      ...
      { 
        ...
        latitude: 41.408165, 
        longitude: 2.151666, 
        image_url: '/images/barcelona/parc-guell.jpg', 
      ...
      { 
        ...
        latitude: 41.388331, 
        longitude: 2.158999, 
        image_url: '/images/barcelona/casa-batllo.jpg', 
      ...
      { 
        ...
        latitude: 41.363508, 
        longitude: 2.158389, 
        image_url: '/images/barcelona/parc-montjuic.jpg', 
  ...
  {
    name: 'Sevilla',
    image_url: '/images/sevilla/plaza-espana.jpg',
    ...
    monuments: [
      { 
        ...
        latitude: 37.385048, 
        longitude: -5.988770, 
        image_url: '/images/sevilla/giralda.jpg', 
      ...
      { 
        ...
        latitude: 37.383665, 
        longitude: -5.988162, 
        image_url: '/images/sevilla/alcazar.jpg', 
      ...
      { 
        ...
        latitude: 37.383480, 
        longitude: -6.003110, 
        image_url: '/images/sevilla/triana.jpg', 
  ...
  {
    name: 'Valencia',
    image_url: '/images/valencia/ciudad-de-las-artes.jpg',
    ...
    monuments: [
      ...
      { 
        ...
        latitude: 39.474444, 
        longitude: -0.378333, 
        image_url: '/images/valencia/lonja-de-la-seda.jpg', 
      ...
      { 
        ...
        latitude: 39.479300, 
        longitude: -0.375933, 
        image_url: '/images/valencia/torres-de-serranos.jpg', 
      ...
      { 
        ...
        latitude: 39.475686, 
        longitude: -0.383975, 
        image_url: '/images/valencia/torres-de-quart.jpg', 
      ...
      { 
        ...
        latitude: 39.474969, 
        longitude: -0.375497, 
        image_url: '/images/valencia/miguelete.jpg', 
      ...
      { 
        ...
        latitude: 39.473503, 
        longitude: -0.378942, 
        image_url: '/images/valencia/mercado-central.jpg', 
...
cities_with_monuments.each do |city_data|
  ...
  city_data[:monuments].each do |monument_data|
    ...
    Monument.create!(
      ...
      monument_link: monument_data[:monument_link]
    )
  end
end
